...
class url:
    ...
    clang_prebuilt_binary_for_macos = 'http://releases.llvm.org/9.0.0/clang+llvm-9.0.0-x86_64-darwin-apple.tar.xz'
    clang_prebuilt_binary_for_ubuntu_lts_18 = 'http://releases.llvm.org/9.0.0/clang+llvm-9.0.0-x86_64-linux-gnu-ubuntu-18.04.tar.xz'
