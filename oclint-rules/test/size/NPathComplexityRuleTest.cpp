...
TEST_F(NPathComplexityRuleTest,
...
TEST_F(NPathComplexityRuleTest, NestedIfElseStmt) {
    testRuleOnCode(new NPathComplexityRule(),
...
TEST_F(NPathComplexityRuleTest, ObjCForeachStmtWithEmptyCompoundStmt) {
    testRuleOnObjCCode(new NPathComplexityRule(),
                       "void mthd() { id anArray; for (id it in anArray) {} }",
...
TEST_F(NPathComplexityRuleTest, ObjCForeachStmtWithCompoundStmtWithIfStmt) {
    testRuleOnObjCCode(new NPathComplexityRule(),
                       "void mthd() { id anArray; for (id it in anArray) { if (1) {} } }",
...
TEST_F(NPathComplexityRuleTest, SwitchStmtWithSimpleConditionAndOneCaseOneDefault) {
    testRuleOnCode(new NPathComplexityRule(),
                   "void mthd() { int i; switch (i) { case 1: break; default: break; } }",
...
TEST_F(NPathComplexityRuleTest, SuppressHighNPathComplexity) {
    testRuleOnCode(new NPathComplexityRule(),
                   "void __attribute__((annotate(\"oclint:suppress[high npath complexity]\"))) mthd() { if (1 ? 2 : 3) {} }");
}
