...
TEST_F(CyclomaticComplexityRuleTest, OneObjCForCollectionStatement) {
    testRuleOnObjCCode(new CyclomaticComplexityRule(),
                       "void aMethod() { id array; for(id one in array) {} }",
...
TEST_F(CyclomaticComplexityRuleTest, OneCaseStatement) {
    testRuleOnCode(new CyclomaticComplexityRule(),
                   "void aMethod() { int i = 1; switch (i) { case 1: break; } }",
                   0, 1, 1, 1, 59, "Cyclomatic Complexity Number 2 exceeds limit of 1");
}

TEST_F(CyclomaticComplexityRuleTest, TwoCaseStatements) {
    testRuleOnCode(new CyclomaticComplexityRule(),
                   "void aMethod() { int i = 1; switch (i) { case 1: case 2: break; } }",
...
TEST_F(CyclomaticComplexityRuleTest, SuppressCyclomaticComplexity) {
    testRuleOnCode(new CyclomaticComplexityRule(),
                   "void __attribute__((annotate(\"oclint:suppress[high cyclomatic complexity]\"))) aMethod() { int b = 1 || 0; }");
}
