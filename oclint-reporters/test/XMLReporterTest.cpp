...
TEST_F(XMLReporterTest, WriteHeader) {
    ...
    EXPECT_THAT(oss.str(),
                StrEq("<?xml version=\"1.0\" encoding=\"UTF-8\" ?><oclint version=\"test\" url=\"http://oclint.org\">"));
}
...
TEST_F(XMLReporterTest, WriteSummary) {
    ...
    EXPECT_THAT(oss.str(),
                HasSubstr("<property name=\"number of priority 1 violations\">0</property>"));
    EXPECT_THAT(oss.str(),
                HasSubstr("<property name=\"number of priority 2 violations\">0</property>"));
    EXPECT_THAT(oss.str(),
                HasSubstr("<property name=\"number of priority 3 violations\">0</property>"));
}
